...
Libft es el primer proyecto de la escuela 42. ✨ Descripción del
proyecto

El objetivo principal de Libft es desarrollar nuestra propia biblioteca
de funciones C. 📖 Descripción de funciones 
...
-ft_putnbr_fd: Escribe un número en un descriptor de archivo. 6. 🏆
Funciones Bonus
